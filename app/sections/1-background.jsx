  ...
  return (
    ...
    >
      ...
      <Graph
        ...
        className="full"
        src="/graphs/1-background/ethnicity.html"
      />
      <Graph
      ...
      <Graph
        ...
        className="full"
        src="/graphs/1-background/religion.html"
      ></Graph>
      <Graph
      ...
      <Graph
        ...
        src="/graphs/1-background/parent-income.html"
      />
      <Graph
        title="The sexual orientations of our class is similar to the university."
        className="full"
        src="/graphs/1-background/sexual-orientation.html"
      />
      <SpotifyEmbed
