...
export default function About() {
  return (
    <Section
      bgColor="bg-zinc-900"
      className="h-full text-white space-y-8"
      id="Home"
    >
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          lived experiences of the class from the beginning of 1A in Fall 2019,
          up until graduation in Spring 2024.
        </p>
      </div>
      <div className="space-y-2">
        <h3>What&#39;s SYDE?</h3>
        <p>
          ...
          focusing on systems theory and user-centric design through mechanical
          and electrical engineering fields. The curriculum emphasizes
          continuous design iterations, user testing, and feedback to develop
          technical skills and user design thinking.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <p>
          ...
          2024 students participated in this survey between Feb 2024 - Mar 2024.
        </p>
      </div>
      <div className="space-y-2">
